...
export function PodcastDetailsPresenter({
  ...
  return (
    <MainLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 md:flex md:flex-col md:h-[calc(100vh-4rem)]">
        <div className="flex flex-col md:flex-row gap-6 md:gap-8 md:h-full md:overflow-hidden">
          {/* Podcast Info */}
          <div className="md:w-1/3 md:overflow-y-auto md:pr-4">
            <div className="bg-gray-200 h-48 sm:h-56 md:h-64 w-full rounded-lg relative mb-4 overflow-hidden">
              <PodcastImage
            ...
            <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">{episodes.length} episodes</p>
            <p className="text-sm sm:text-base text-gray-700 mb-4 sm:mb-6">{podcast.description}</p>
          ...
          <div className="md:w-2/3 md:flex md:flex-col md:overflow-hidden">
            <h2 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6">Episodes ({episodes.length})</h2>

            {episodes.length > 0 ? (
              <div className="space-y-4 sm:space-y-6 md:overflow-y-auto md:pr-1">
              ...
              <div className="text-center py-8 sm:py-12 bg-gray-50 rounded-lg">
                <p className="text-base sm:text-lg md:text-xl text-gray-500">No episodes available at the moment.</p>
              </div>
            )}
          </div>
        </div>
